...
def parseOutput(path):
    ...
    return num_producer, num_consumer, prod_ans, cons_ans, prods_exit_num, cons_exit_num, time
...
# print(fname)
prod_num, cons_num, prod_list, cons_list, prods_exit_num, cons_exit_num, time = parseOutput(path + "/output/" + fname)
succ_str = "Success"
...
if sorted(cons_list) != sorted(input_data):
    ...
    succ_str = "Failure"
if prods_exit_num != num_producer * 5:
    print("{} producers spawn, but {} exit".format(num_producer * 5, prods_exit_num))
    succ_str = "Failure"
if cons_exit_num != num_consumer * 5:
    print("{} consumers spawn, but {} exit".format(num_consumer * 5, cons_exit_num))
    succ_str = "Failure"
